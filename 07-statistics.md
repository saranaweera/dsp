...
>> In this case we have to find the probability of a boy-boy identical twin, given that it is a twin. However, probabilities breakdown for different gender permutations for identical and fraternal twins are not given. So, I will assume 50% probability of boy-boy if identical twin and 25% probability of boy-boy if fraternal twin. With that assumption probability of being a boy-boy twin is 0.5*(1/300) + 0.25 * (1/125).  Given that it is a boy-boy twin probability of a an identical boy-boy twin is (.5 * 1/300) / ((.5 * 1/300) + (.25 * 1/125)) = .454545 . So, the probability of Elvis Presley twin being identical is 45.4545%

### Q6. Bayesian &amp; Frequentist Comparison  
How do frequentist and Bayesian statistics compare?

>> Frequentist and Bayesian statistics are two different schools of thought in the world of statistics. Frequentist statistics believe that data is repeatable random samples, underlying parameters remain constant during the repeatable process and parameters are fixed. While Bayesian statistics takes the view that data is observed from the realized sample and parameters are unknown and described probabilistically and that the data is fixed.
